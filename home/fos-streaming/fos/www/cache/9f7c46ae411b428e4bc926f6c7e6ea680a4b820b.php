                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="name" class="form-control col-md-7 col-xs-12"  value="<?php echo e(isset($_POST['name']) ?  $_POST['name'] : $useragentblock->name); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" name="description" placeholder='' rows="3"><?php echo e($useragentblock->description); ?></textarea>
                            </div>
                        </div>
