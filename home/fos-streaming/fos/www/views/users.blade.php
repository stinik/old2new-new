                            ...
                            @foreach($users as $key => $user)
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="autoEnigma" username="{{$user->username}}" password="{{$user->password}}" href="javascript:;" data-toggle="modal" data-target="#autoenigma2"><span class="label label-success">Auto Enigma2</span></a>
                                    </td>
...
$(document).ready(function () {
	...
	$("#testAU2").val('wget -O /etc/enigma2/vtpi.sh "http://{{ $setting->webip }}:{{ $setting->webport }}/retrieve.php?username='+_username+'&password='+_password+'&type=auto_enigma2_oe2&output=mpegts" && chmod 777 /etc/enigma2/vtpi.sh && /etc/enigma2/vtpi.sh')
